...
/* Inference Thread. The software TFLM model (CMSIS-NN kernels) needs far
 * more stack than the NPU path this was originally sized for -- 4 KB
 * overflows inside Invoke() and corrupts adjacent memory.
 */
#define THREAD_INF_STACKSIZE	8192
